...
public class PowerOutagesController {
    ...
    void doCreaGrafo(ActionEvent event) {
    	...
    	List<Nerc> n= model.creaGrafo();
    	cmbBoxNerc.getItems().addAll(n);
    	flag=true;
    ...
    void doVisualizzaVicini(ActionEvent event) {
    	...
    	{
    		txtResult.appendText("ERRORE: assicurarsi di aver creato il grafo e poi selezionare un nerc\n");
    		return;
    	}
    	
    	String ris = model.visualizzaVicini(n);
